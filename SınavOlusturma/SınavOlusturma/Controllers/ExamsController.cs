    ...
    public class ExamsController : Controller
    {
        ...
        public IActionResult AddExam()
        {
                var posts = GetTextTitles(5);
                    ...
                    List<TitleViewModel> textViewModels = new List<TitleViewModel>();

                    foreach (var post in posts)
                    {
                        var textViewModel = new TitleViewModel()
                        {
                            Id = post.Id,
        ...
        */
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Text,Date")] Exam exam)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Text,Date")] Exam exam)
        {
            if (id != exam.Id)
            {
                return NotFound();
